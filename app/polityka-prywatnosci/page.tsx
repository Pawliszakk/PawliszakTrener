		...
		<div className={classes.box}>
			...
			<ol>
				<li>
					...
					url: <b>pawlisaktrener.pl</b>
				</li>
				<li>
					{' '}
					Operatorem serwisu oraz Administratorem danych osobowych jest: Oskar
					Pawliszak Piłsudskiego 11 22-435 Komarów-Osada
				</li>
				<li>
					{' '}
					Adres kontaktowy poczty elektronicznej operatora:
					oskar.pawliszak1@o2.pl
				</li>
				<li>
					{' '}
